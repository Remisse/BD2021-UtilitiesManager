...
public class ZoneRecord extends UpdatableRecordImpl<ZoneRecord> implements Record3<Integer, String, String> {
    ...
    @Override
    public ZoneRecord values(Integer value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public ZoneRecord(Integer idzona, String comune, String provincia) {
        super(Zone.ZONE);
