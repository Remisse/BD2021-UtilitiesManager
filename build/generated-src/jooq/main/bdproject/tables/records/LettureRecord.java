...
public class LettureRecord extends UpdatableRecordImpl<LettureRecord> implements Record5<BigDecimal, String, LocalDate, Byte, Integer> {
     ...
     */
    public LettureRecord setContatore(String value) {
        set(1, value);
        return this;
    }
    ...
    @Override
    public Row5<BigDecimal, String, LocalDate, Byte, Integer> valuesRow() {
    ...
    @Override
    public LettureRecord values(BigDecimal value1, String value2, LocalDate value3, Byte value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LettureRecord(BigDecimal consumi, String contatore, LocalDate dataeffettuazione, Byte confermata, Integer cliente) {
        super(Letture.LETTURE);
