...
public class BolletteRecord extends UpdatableRecordImpl<BolletteRecord> implements Record8<Integer, LocalDate, LocalDate, LocalDate, BigDecimal, byte[], Byte, Integer> {
    ...
    /**
     * Setter for <code>utenze.bollette.EmessaDa</code>.
     */
    public BolletteRecord setEmessada(Integer value) {
        set(7, value);
        return this;
    }
    ...
    @Override
    public Row8<Integer, LocalDate, LocalDate, LocalDate, BigDecimal, byte[], Byte, Integer> valuesRow() {
    ...
    public Field<Integer> field8() {
        return Bollette.BOLLETTE.EMESSADA;
    }
    ...
    @Override
    public BolletteRecord value8(Integer value) {
        setEmessada(value);
        return this;
    }

    @Override
    public BolletteRecord values(Integer value1, LocalDate value2, LocalDate value3, LocalDate value4, BigDecimal value5, byte[] value6, Byte value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BolletteRecord(Integer idcontratto, LocalDate dataemissione, LocalDate datascadenza, LocalDate datapagamento, BigDecimal importo, byte[] dettagliobolletta, Byte stimata, Integer emessada) {
        super(Bollette.BOLLETTE);
