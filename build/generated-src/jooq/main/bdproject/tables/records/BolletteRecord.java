...
public class BolletteRecord extends UpdatableRecordImpl<BolletteRecord> implements Record7<Integer, LocalDate, LocalDate, LocalDate, BigDecimal, byte[], Byte> {
    ...
    @Override
    public Row7<Integer, LocalDate, LocalDate, LocalDate, BigDecimal, byte[], Byte> valuesRow() {
    ...
    @Override
    public BolletteRecord values(Integer value1, LocalDate value2, LocalDate value3, LocalDate value4, BigDecimal value5, byte[] value6, Byte value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BolletteRecord(Integer idcontratto, LocalDate dataemissione, LocalDate datascadenza, LocalDate datapagamento, BigDecimal importo, byte[] dettagliobolletta, Byte stimata) {
        super(Bollette.BOLLETTE);
