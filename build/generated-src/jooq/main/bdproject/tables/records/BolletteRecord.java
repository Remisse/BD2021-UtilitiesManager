...
public class BolletteRecord extends UpdatableRecordImpl<BolletteRecord> implements Record9<Integer, LocalDate, LocalDate, LocalDate, BigDecimal, BigDecimal, Byte, BigDecimal, BigDecimal> {
    ...
    /**
     * Setter for <code>utenze.bollette.ParzialeCanoneRai</code>.
     */
    public BolletteRecord setParzialecanonerai(BigDecimal value) {
        set(7, value);
        return this;
    }
    ...
    @Override
    public Row9<Integer, LocalDate, LocalDate, LocalDate, BigDecimal, BigDecimal, Byte, BigDecimal, BigDecimal> valuesRow() {
    ...
    public Field<BigDecimal> field8() {
        return Bollette.BOLLETTE.PARZIALECANONERAI;
    }
    ...
    public BolletteRecord value8(BigDecimal value) {
        setParzialecanonerai(value);
        return this;
    }

    @Override
    public BolletteRecord value9(BigDecimal value) {
        setCostoattivazione(value);
        return this;
    }

    @Override
    public BolletteRecord values(Integer value1, LocalDate value2, LocalDate value3, LocalDate value4, BigDecimal value5, BigDecimal value6, Byte value7, BigDecimal value8, BigDecimal value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BolletteRecord(Integer idcontratto, LocalDate dataemissione, LocalDate datascadenza, LocalDate datapagamento, BigDecimal importo, BigDecimal consumi, Byte stimata, BigDecimal parzialecanonerai, BigDecimal costoattivazione) {
        super(Bollette.BOLLETTE);
        ...
        setConsumi(consumi);
        setStimata(stimata);
        setParzialecanonerai(parzialecanonerai);
    ...
    public BolletteRecord(bdproject.tables.pojos.Bollette value) {
        ...
        if (value != null) {
            ...
            setParzialecanonerai(value.getParzialecanonerai());
