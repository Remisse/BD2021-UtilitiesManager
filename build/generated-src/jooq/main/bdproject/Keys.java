...
public class Keys {
    ...
    public static final ForeignKey<LettureRecord, ContatoriRecord> FK_CORRISPONDENZA = Internal.createForeignKey(Letture.LETTURE, DSL.name("FK_CORRISPONDENZA"), new TableField[] { Letture.LETTURE.CONTATORE }, Keys.KEY_CONTATORI_PRIMARY, new TableField[] { Contatori.CONTATORI.MATRICOLA }, true);
    ...
    public static final ForeignKey<RichiesteAttivazioneRecord, ContatoriRecord> FK_COLLEGAMENTO = Internal.createForeignKey(RichiesteAttivazione.RICHIESTE_ATTIVAZIONE, DSL.name("FK_COLLEGAMENTO"), new TableField[] { RichiesteAttivazione.RICHIESTE_ATTIVAZIONE.CONTATORE }, Keys.KEY_CONTATORI_PRIMARY, new TableField[] { Contatori.CONTATORI.MATRICOLA }, true);
