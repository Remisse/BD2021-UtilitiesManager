...
public class Keys {
    ...
    public static final ForeignKey<LettureRecord, ClientiRecord> FK_EFFETTUAZIONE = Internal.createForeignKey(Letture.LETTURE, DSL.name("FK_EFFETTUAZIONE"), new TableField[] { Letture.LETTURE.IDCLIENTE }, Keys.KEY_CLIENTI_PRIMARY, new TableField[] { Clienti.CLIENTI.CODICECLIENTE }, true);
