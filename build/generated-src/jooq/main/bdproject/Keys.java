...
public class Keys {
    ...
    public static final UniqueKey<ContatoriRecord> KEY_CONTATORI_AK1_CONTATORI = Internal.createUniqueKey(Contatori.CONTATORI, DSL.name("KEY_contatori_AK1_CONTATORI"), new TableField[] { Contatori.CONTATORI.MATRICOLA }, true);
    ...
    public static final UniqueKey<ContatoriRecord> KEY_CONTATORI_PRIMARY = Internal.createUniqueKey(Contatori.CONTATORI, DSL.name("KEY_contatori_PRIMARY"), new TableField[] { Contatori.CONTATORI.PROGRESSIVO }, true);
    ...
    public static final UniqueKey<RedditiRecord> KEY_REDDITI_PRIMARY = Internal.createUniqueKey(Redditi.REDDITI, DSL.name("KEY_redditi_PRIMARY"), new TableField[] { Redditi.REDDITI.CODICE }, true);
    ...
    public static final ForeignKey<ClientiRecord, RedditiRecord> FK_POSSEDIMENTO = Internal.createForeignKey(Clienti.CLIENTI, DSL.name("FK_POSSEDIMENTO"), new TableField[] { Clienti.CLIENTI.FASCIAREDDITO }, Keys.KEY_REDDITI_PRIMARY, new TableField[] { Redditi.REDDITI.CODICE }, true);
    ...
    public static final ForeignKey<RichiesteAttivazioneRecord, ContatoriRecord> FK_COLLEGAMENTO = Internal.createForeignKey(RichiesteAttivazione.RICHIESTE_ATTIVAZIONE, DSL.name("FK_COLLEGAMENTO"), new TableField[] { RichiesteAttivazione.RICHIESTE_ATTIVAZIONE.CONTATORE }, Keys.KEY_CONTATORI_PRIMARY, new TableField[] { Contatori.CONTATORI.PROGRESSIVO }, true);
    public static final ForeignKey<RichiesteAttivazioneRecord, OperatoriRecord> FK_OPERATORE_ATT = Internal.createForeignKey(RichiesteAttivazione.RICHIESTE_ATTIVAZIONE, DSL.name("FK_OPERATORE_ATT"), new TableField[] { RichiesteAttivazione.RICHIESTE_ATTIVAZIONE.OPERATORE }, Keys.KEY_OPERATORI_PRIMARY, new TableField[] { Operatori.OPERATORI.CODICEOPERATORE }, true);
    ...
    public static final ForeignKey<RichiesteCessazioneRecord, OperatoriRecord> FK_OPERATORE_CES = Internal.createForeignKey(RichiesteCessazione.RICHIESTE_CESSAZIONE, DSL.name("FK_OPERATORE_CES"), new TableField[] { RichiesteCessazione.RICHIESTE_CESSAZIONE.OPERATORE }, Keys.KEY_OPERATORI_PRIMARY, new TableField[] { Operatori.OPERATORI.CODICEOPERATORE }, true);
