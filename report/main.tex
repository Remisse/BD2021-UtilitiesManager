...
\begin{longtable}{l p{10cm} c r}
    ...
    \textbf{OP-28} & Visualizzare la media aggregata dei consumi (reali e stimati) prodotti in un dato periodo e relativi a tutti i contratti attivi in un dato comune & 1.000/mese \\
